...
_EjectShellCasing EjectShellCasing_Copied1;
_EjectShellCasing EjectShellCasing_Copied2;
...
{
	ammoCountData = CalcClipAmmoCounter_Copied(ammoCountData);
...
{
	_DEBUG("Casing_hook");
	return EjectShellCasing_Copied1(ref, instanceData, eqIdx);
}
...
UInt8 PlayerAnimationEvent_Hook(void* arg1, BSAnimationGraphEvent* arg2, void** arg3)
{
	...
	{
		_DEBUG("reloadEnd");
		//ExtraWeaponState::HandleWeaponStateEvents(ExtraWeaponState::kEventTypeReload, *g_player, ExtraWeaponState::bEventTypeReloadEndBCR, 0); //BCR!!
		MSF_MainData::modSwitchManager.SetIsBCRreload(0);
...
//hkbBehaviorGraphData: 60:hkbVariableValueSet; 68:hkbBehaviorGraphStringData: 10: array*, 18: length
//hkbBehaviorGraph: 30:ptr2self, 38: std::string?(name), C0: hkbStateMachine, C8: hkbBehaviorGraphData