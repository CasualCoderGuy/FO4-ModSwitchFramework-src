...
#define MSF_VERSION_INTEGER_PATCH	9
...
#define MIN_SUPPORTED_SWF_GLOBAL_VERSION		MAKE_EXE_VERSION_EX(1, 4, 0, 1)
#define MIN_SUPPORTED_SERIALIZATION_VERSION		MAKE_EXE_VERSION_EX(1, 2, 9, 3)
