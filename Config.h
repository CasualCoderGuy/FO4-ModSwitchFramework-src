...
#define MSF_VERSION_INTEGER_BETA	2
#define MSF_VERSION_RELEASEID		0

#ifdef DEBUG
#define MSF_VERSION_STRING		"0.0.0.2" 
...
#else
#define MSF_VERSION_STRING		"0.0.2"
#define MSF_VERSION				MAKE_EXE_VERSION_EX(MSF_VERSION_INTEGER_MAJOR, MSF_VERSION_INTEGER_MINOR, MSF_VERSION_INTEGER_PATCH, 0)
#endif

#define MIN_SUPPORTED_KB_VERSION			MAKE_EXE_VERSION_EX(0, 0, 0, 1)
#define MIN_SUPPORTED_DATA_VERSION			MAKE_EXE_VERSION_EX(0, 0, 0, 2)
